    ...
    __gm__ uint8_t* tiling)
{
    if (TILING_KEY_VAR >= SASA_BASE_TILING) {
        ...
        SasaInferInterfaceFullQuant<fp8_e4m3fn_t, bfloat16_t, float, SasaKernelArch35::Format::NTD, true, true>(
            ...
            qDequantScale, kDequantScale, vDequantScale,
            attentionOut, softmaxLse, user, tiling);
#elif TILING_KEY_VAR == SASA_FP16_D128_ARCH35_NTD_TILING
        SasaInferIntfRegular<half, half, float, SasaKernelArch35::Format::NTD, false>(
            query, key, value, selectIdx, blockTable, selectNumIdx,
            actualSeqLengths, actualSeqLengthsKv,
            attentionOut, softmaxLse, user, tiling);
#elif TILING_KEY_VAR == SASA_BF16_D128_ARCH35_NTD_TILING
        SasaInferIntfRegular<bfloat16_t, bfloat16_t, float, SasaKernelArch35::Format::NTD, false>(
            query, key, value, selectIdx, blockTable, selectNumIdx,
            actualSeqLengths, actualSeqLengthsKv,
            attentionOut, softmaxLse, user, tiling);
#elif TILING_KEY_VAR == SASA_FP16_D128_ARCH35_NTD_FD_TILING
        SasaInferIntfRegular<half, half, float, SasaKernelArch35::Format::NTD, true>(
            query, key, value, selectIdx, blockTable, selectNumIdx,
            actualSeqLengths, actualSeqLengthsKv,
            attentionOut, softmaxLse, user, tiling);
#elif TILING_KEY_VAR == SASA_BF16_D128_ARCH35_NTD_FD_TILING
        SasaInferIntfRegular<bfloat16_t, bfloat16_t, float, SasaKernelArch35::Format::NTD, true>(
            query, key, value, selectIdx, blockTable, selectNumIdx,
            actualSeqLengths, actualSeqLengthsKv,
            attentionOut, softmaxLse, user, tiling);
#endif
        ...
        TILING_KEY_IS(SASA_FP16_D128_ARCH22_NTD_TILING);
        TILING_KEY_IS(SASA_BF16_D128_ARCH22_NTD_TILING);
        TILING_KEY_IS(SASA_FP16_D128_ARCH22_NTD_FD_TILING);
        TILING_KEY_IS(SASA_BF16_D128_ARCH22_NTD_FD_TILING);

#if TILING_KEY_VAR == SASA_FP16_D128_ARCH22_TILING
        SasaInferIntfRegularArch22<half, float, false, false>(
            query, key, value, selectIdx, blockTable, selectNumIdx,
            actualSeqLengths, actualSeqLengthsKv,
            attentionOut, softmaxLse, user, tiling);
#elif TILING_KEY_VAR == SASA_BF16_D128_ARCH22_TILING
        SasaInferIntfRegularArch22<bfloat16_t, float, false, false>(
            query, key, value, selectIdx, blockTable, selectNumIdx,
            actualSeqLengths, actualSeqLengthsKv,
            attentionOut, softmaxLse, user, tiling);
#elif TILING_KEY_VAR == SASA_FP16_D128_ARCH22_FD_TILING
        SasaInferIntfRegularArch22<half, float, true, false>(
            query, key, value, selectIdx, blockTable, selectNumIdx,
            actualSeqLengths, actualSeqLengthsKv,
            attentionOut, softmaxLse, user, tiling);
#elif TILING_KEY_VAR == SASA_BF16_D128_ARCH22_FD_TILING
        SasaInferIntfRegularArch22<bfloat16_t, float, true, false>(
            query, key, value, selectIdx, blockTable, selectNumIdx,
            actualSeqLengths, actualSeqLengthsKv,
            attentionOut, softmaxLse, user, tiling);
#elif TILING_KEY_VAR == SASA_FP16_D128_ARCH22_NTD_TILING
        SasaInferIntfRegularArch22<half, float, false, true>(
            query, key, value, selectIdx, blockTable, selectNumIdx,
            actualSeqLengths, actualSeqLengthsKv,
            attentionOut, softmaxLse, user, tiling);
#elif TILING_KEY_VAR == SASA_BF16_D128_ARCH22_NTD_TILING
        SasaInferIntfRegularArch22<bfloat16_t, float, false, true>(
            query, key, value, selectIdx, blockTable, selectNumIdx,
            actualSeqLengths, actualSeqLengthsKv,
            attentionOut, softmaxLse, user, tiling);
#elif TILING_KEY_VAR == SASA_FP16_D128_ARCH22_NTD_FD_TILING
        SasaInferIntfRegularArch22<half, float, true, true>(
            query, key, value, selectIdx, blockTable, selectNumIdx,
            actualSeqLengths, actualSeqLengthsKv,
            attentionOut, softmaxLse, user, tiling);
#elif TILING_KEY_VAR == SASA_BF16_D128_ARCH22_NTD_FD_TILING
        SasaInferIntfRegularArch22<bfloat16_t, float, true, true>(
            query, key, value, selectIdx, blockTable, selectNumIdx,
            actualSeqLengths, actualSeqLengthsKv,
            attentionOut, softmaxLse, user, tiling);
#endif
