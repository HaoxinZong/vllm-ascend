...
/*!
 * \file sparse_attention_score_950_kernel_interface.cpp
 * \brief Sparse Attention Score Kernel Interface
 */
#include "kernel_operator.h"
#if (__CCE_AICORE__ == 220)
#include "arch22/sparse_attention_score_950_kernel_arch22.h"
#endif
#if (__CCE_AICORE__ == 310)
#include "arch35/sparse_attention_score_950_kernel_arch35.h"
#include "arch35/sparse_attention_score_950_kernel_arch35_full_quant.h"
#endif
...
template <class InDtype, class SMDtype, bool IS_FD, bool IS_NTD>
    ...
    GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    using SasaKernel = SasaRegularKernelArch22<
        BlockMmadQK, EpilogueOnlineSoftmax, BlockMmadPV, EpilogueRescaleO, IS_FD, IS_NTD>;
