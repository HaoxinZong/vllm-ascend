 ...
 */
#ifndef SASA_PREFILL_ARCH35_KERNEL_UTILS
#define SASA_PREFILL_ARCH35_KERNEL_UTILS
...
struct SasaPrefillKernelParamsArch35 {
    GM_ADDR q;
    GM_ADDR k;
    GM_ADDR v;
    GM_ADDR blockTable;
...
#endif  // SASA_PREFILL_ARCH35_KERNEL_UTILS
