...
# Adapt from https://github.com/vllm-project/vllm/blob/main/vllm/models/minimax_m3/common/ops/index_topk.py
# Adapt from https://github.com/vllm-project/vllm/blob/main/vllm/models/minimax_m3/common/sparse_attention.py
# The kernels accept K/V cache tensors directly so Ascend's split cache layout does not need to be materialized
# into the GPU  ``[num_blocks, 2, ...]`` layout.
#
