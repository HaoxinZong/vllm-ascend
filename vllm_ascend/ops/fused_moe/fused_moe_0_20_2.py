...
#
# This file is based on vllm-ascend commit 775cd396 for the vLLM 0.20.2
# MiniMax debug path. Keep the 0.20.2 compatibility branches below; they are
# intentionally different from the newer vLLM 0.21.0 fused_moe.py.
